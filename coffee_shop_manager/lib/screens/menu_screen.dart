...
class _MenuScreenState extends State<MenuScreen> {
  ...
  final List<String> _categories = ['Tất cả', 'Cà phê', 'Trà', 'Trà sữa', 'Sinh tố', 'Đá xay'];
  final List<String> _priceRanges = ['Tất cả', 'Dưới 50k', '50k - 80k', 'Trên 80k'];
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final filteredDrinks = appState.drinks.where((drink) {
          ...
          // 2. Category
          final matchesCategory = _selectedCategory == 'Tất cả' || drink.type == _selectedCategory;
        ...
        return Scaffold(
              ...
              Expanded(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFF5D4037)),
                  ),
                      ...
                      children: _categories.map((category) {
                        ...
                        return Padding(
                          ...
                          child: ChoiceChip(
                            ...
                            labelStyle: TextStyle(color: isSelected ? Colors.white : const Color(0xFF5D4037)),
                    ...
                    children: _priceRanges.map((range) {
                      ...
                      return Padding(
                        ...
                        child: ChoiceChip(
                          ...
                          labelStyle: TextStyle(color: isSelected ? Colors.white : const Color(0xFF8D6E63)),
                          backgroundColor: Colors.white,
                          onSelected: (selected) {
                            if (selected) {
                              setState(() {
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                ...
                                                child: ElevatedButton(
                                                  key: ValueKey('order_btn_${drink.name}'),
                                                  ...
                                                  onPressed: isOutOfStock
                                                      ? null
                                                      : () {
                                                          final res = appState.addToCart(drink);
                                                          if (res != 'Success') {
                                                            ...
                                                            ScaffoldMessenger.of(context).showSnackBar(
                                                              SnackBar(
                                                                content: Text('Đã thêm ${drink.name} vào đơn hàng'),
          ...
          if (isDesktop)
            Expanded(
              flex: 4,
              child: OrderCartPanel(isHistoryOnly: false),
            )
        ],
      ),
              ...
              onPressed: () {
                ...
                showModalBottomSheet(
                  ...
                  builder: (context) => DraggableScrollableSheet(
                    ...
                    minChildSize: 0.5,
                    expand: false,
                    builder: (context, scrollController) => const OrderCartPanel(isHistoryOnly: false),
                  ),
                );
              },
            )
